...
x1 = [10000000, 50000000, 100000000, 500000000,
1000000000]
y1 = [0.15, 0.73, 1.42, 7.08, 14.14]
plt.plot(x1, y1, label = "Média 2", color = "blue",
...
plt.plot(x2, y2, label = "Média 1", color = "red",
linestyle = "dashed", linewidth = 2, marker = 'o',
...
plt.legend()
plt.showfig('Tarefa1TinosMedias1e2.png')