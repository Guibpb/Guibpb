...
path2 = Path.home() / '.local/share/godot/app_userdata/Physics_Simulation' / 'posicoesp1SegundaIteracao.txt'
...
plt.title("Trajetórias - Planeta 1")
plt.xlabel("Posição X")
plt.ylabel("Posição Y")
plt.grid(True)
plt.axis("equal")
plt.legend()
plt.savefig('TrajetoriasPlaneta2.png')